import './navbar-custom-pure.styles.css';
import Nav from 'react-bootstrap/Nav';
import Navbar from 'react-bootstrap/Navbar';
import HighlightsIcons from './highlights-icons/highlights-icons.component.jsx';

function NavbarCustomPure({ placeholder, setPlaceholder }) {

	return (
		<Navbar id="navbar-custom" collapseOnSelect expand="lg">
...
export default NavbarCustomPure;
